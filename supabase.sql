...
-- ============================================
-- 9b. ADD previous_balance COLUMN TO INVOICES
-- ============================================
-- Stores the customer's outstanding balance BEFORE this invoice was added.
-- Used to correctly display "Previous Balance" and "Amount Payable" when
-- re-printing invoices from History or Sales Report pages.
